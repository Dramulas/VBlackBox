...
import 'package:VBlackBox/sliver_appbar_title.dart';
    ...
    return Container(
        ...
        child: ListTile(
            title: Row(
                ...
                children: [
                  Text(ability['name'].toString().toUpperCase(),
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Text(ability['cost'].toString().toUpperCase(),
